...
| How do I activate my WS VMs?                                         | Automatically handled – no keys/true-up. AVMA key activation needs to be installed at guest VM.                                                                                                                                                                            | Key based – for example, KMS/AVMA/enter keys in VM.                                                                                                                                                                                 |
